...
class RelocationOptimizer:
    ...
    def __initial_optimization(self, starting_time_frame: int, initial_state: list):
    ...
    def __lp_problem(self, starting_time_frame: int, initial_state: list):
    ...
    def __milp_problem(self, starting_time_frame: int, initial_state: list, fix_zero_relocation: list = None):
    ...
    def __relocation_rounding(self, r):
    ...
    def __neighbourhood_search(self, r0: list, initial_state: list, starting_time_frame: int):
    ...
    def __round_flows(self, EO: list, EI: list, r: list, s: list):
    ...
    def __get_rounding_indexes(self, array: list, rounded_array: list):
    ...
    def __system_lp_problem(self, r: list, s: list, time_frame: int, starting_time_frame: int):
    ...
    def __monte_carlo_simulation(self, r, initial_state, starting_time_frame):
    ...
    def __single_tf_run(self, s: list, r: list, time_frame: int):
